...
public class DayOfWeek {
	...
	public static void main(String[] args) {
		...
		switch (D) {
		case 0:
			System.out.println("Given date falls on --> Sunday");
			break;
		case 1:
			System.out.println("Given date falls on --> Monday");
			break;
		case 2:
			System.out.println("Given date falls on --> Tuesday");
			break;
		case 3:
			System.out.println("Given date falls on --> Wednesday");
			break;
		case 4:
			System.out.println("Given date falls on --> Thursday");
			break;
		case 5:
			System.out.println("Given date falls on --> Friday");
			break;
		case 6:
			System.out.println("Given date falls on --> Saturday");
		}
